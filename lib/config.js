...
export function getKeys() {
  return {
    ...
    NEWSDATA_KEY:           process.env.NEWSDATA_KEY           || null,  // newsdata.io (200 req/day free) — already declared above
...
export const DAILY_LIMITS = {
  gemini:      50,   // Dec 2025: Google cut free tier ~92% — actual RPD now ~50
  groq:        6000,
  cerebras:    1000,
  sambanova:   999999,
  together:    9999,
