...
// ─── INTENT DETECTOR ─────────────────────────────────────────────
const INTENT_MAP = [
  // Simple app name detection — any mention of app + open/kholo/kolo/chala/launch
  // OR just app name alone as short command
  { pattern: /\binstagram\b|\binsta\b/i,            action: 'instagram' },
  { pattern: /\bwhatsapp\b|\bwatsapp\b/i,           action: 'whatsapp' },
  { pattern: /\byoutube\b|\byt\b/i,                 action: 'youtube' },
  { pattern: /\bspotify\b/i,                          action: 'spotify' },
  { pattern: /\bgoogle maps\b|\bmaps kh|maps open|open maps/i, action: 'maps' },
  { pattern: /\bgmail\b/i,                            action: 'gmail' },
  { pattern: /\btelegram\b/i,                         action: 'telegram' },
  { pattern: /\bzomato\b|\bswiggy\b/i,              action: 'zomato' },
  { pattern: /\bgpay\b|\bphonepe\b|\bpaytm\b/i,  action: 'gpay' },
  { pattern: /\bchrome\b|\bbrowser kh/i,             action: 'chrome' },
  { pattern: /\btwitter\b|\b\bx app\b/i,           action: 'twitter' },
  { pattern: /\bcalculator\b|\bcalc kh/i,            action: 'calculator' },
  { pattern: /\bnotion\b/i,                           action: 'notion' },
  // Action-based (need verb to avoid false triggers)
  { pattern: /camera.*kh|open.*camera|kh.*camera/i,    action: 'camera' },
  { pattern: /settings.*kh|open.*settings/i,           action: 'settings' },
  { pattern: /wifi.*setting/i,                          action: 'wifi_settings' },
  { pattern: /ola.*book|cab.*book/i,                    action: 'ola' },
  { pattern: /alarm.*set|alarm.*laga/i,                 action: 'alarm' },
  { pattern: /call karo|dial karo|call kholo/i,         action: 'dialer' },
