...
// ─── INTENT DETECTOR ─────────────────────────────────────────────
const INTENT_MAP = [
  // Apps — both "kholo" and "kolo" variants supported
  { pattern: /youtube.*k[ho]+lo|open.*youtube|yt.*open|youtube.*chala/i,    action: 'youtube' },
  { pattern: /youtube.*search|search.*youtube/i,                             action: 'youtube_search' },
  { pattern: /whatsapp.*k[ho]+lo|open.*whatsapp|whatsapp.*chala/i,          action: 'whatsapp' },
  { pattern: /instagram.*k[ho]+lo|open.*instagram|insta.*k[ho]+lo/i,        action: 'instagram' },
  { pattern: /spotify.*k[ho]+lo|open.*spotify|music.*k[ho]+lo/i,            action: 'spotify' },
  { pattern: /maps.*k[ho]+lo|open.*maps|navigate.*to|maps.*chala/i,         action: 'maps' },
  { pattern: /gmail.*k[ho]+lo|open.*gmail|email.*k[ho]+lo/i,                action: 'gmail' },
  { pattern: /camera.*k[ho]+lo|open.*camera/i,                               action: 'camera' },
  { pattern: /settings.*k[ho]+lo|open.*settings/i,                           action: 'settings' },
  { pattern: /wifi.*setting|wifi.*jaao/i,                                    action: 'wifi_settings' },
  { pattern: /telegram.*k[ho]+lo|open.*telegram/i,                           action: 'telegram' },
  ...
  { pattern: /call.*karo|phone.*karo|dial|call.*k[ho]+lo/i,                  action: 'dialer' },
  { pattern: /notion.*k[ho]+lo|open.*notion/i,                               action: 'notion' },
  { pattern: /chrome.*k[ho]+lo|browser.*k[ho]+lo/i,                          action: 'chrome' },
  { pattern: /calculator.*k[ho]+lo|calc.*k[ho]+lo/i,                         action: 'calculator' },
  { pattern: /twitter.*k[ho]+lo|x.*k[ho]+lo/i,                              action: 'twitter' },
];
