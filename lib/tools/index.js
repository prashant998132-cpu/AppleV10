// lib/tools/index.js — JARVIS v10 Tools Engine
// ═══════════════════════════════════════════════════════════════
// 58 Tools — All free, no mandatory API keys
// Free sources: Open-Meteo, Wikipedia, Exchange Rate API,
//               CoinGecko, NewsData, Open Library, etc.
// Optional keys: GROQ_API_KEY (math), NEWSDATA_KEY (news++)
// ═══════════════════════════════════════════════════════════════
