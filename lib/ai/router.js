...
export function classifyComplexity(message) {
  ...
  const thinkPatterns = [
    ...
    /\b(exam|study|question|answer|neet|mcq|pyq)\b/,
    /\b(biology|botany|zoology|physics|chemistry|ncert|chapter)\b/,
...
export const LLM_CHAIN = [
  // Tier 1 — Fast & Free (March 2026 models)
  { id: 'groq-kimi-k2',       name: 'Groq Kimi K2',           provider: 'groq',       model: 'moonshotai/kimi-k2-instruct',              free: true, speed: 'fast',     quality: 5 },
  { id: 'groq-llama4-scout',  name: 'Groq Llama 4 Scout',     provider: 'groq',       model: 'meta-llama/llama-4-scout-17b-16e-instruct', free: true, speed: 'ultrafast',quality: 4 },
  { id: 'groq-qwen3',         name: 'Groq Qwen 3 32B',        provider: 'groq',       model: 'qwen/qwen3-32b',                           free: true, speed: 'fast',     quality: 5 },
  { id: 'groq-gpt-oss',       name: 'Groq GPT-OSS 120B',      provider: 'groq',       model: 'openai/gpt-oss-120b',                      free: true, speed: 'fast',     quality: 5 },
  { id: 'groq-llama3-70b',    name: 'Groq LLaMA 3.3 70B',     provider: 'groq',       model: 'llama-3.3-70b-versatile',                  free: true, speed: 'fast',     quality: 4 },
  { id: 'groq-llama3-8b',     name: 'Groq LLaMA 3.1 8B',      provider: 'groq',       model: 'llama-3.1-8b-instant',                     free: true, speed: 'instant',  quality: 3 },

  // Tier 2 — Quality
  { id: 'gemini-flash',       name: 'Gemini 2.5 Flash',        provider: 'gemini',     model: 'gemini-2.5-flash',                         free: true, speed: 'medium',   quality: 5 },

  // Tier 3 — OpenRouter (free models)
  { id: 'or-deepseek-v3',     name: 'DeepSeek V3.1 (OpenRouter)', provider: 'openrouter', model: 'deepseek/deepseek-chat-v3-5:free',     free: true, speed: 'medium',   quality: 5 },
  { id: 'or-llama3-70b',      name: 'LLaMA 3.3 70B (OpenRouter)', provider: 'openrouter', model: 'meta-llama/llama-3.3-70b-instruct:free', free: true, speed: 'medium', quality: 4 },
...
export async function callGroq(messages, systemPrompt, apiKey, model = 'llama-3.3-70b-versatile') {
...
async function callGemini(messages, systemPrompt, apiKey, model = 'gemini-2.5-flash') {
