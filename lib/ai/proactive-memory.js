...
const FACT_PATTERNS = [
  ...
  // Relationships
  { pattern: /\b(friend|dost|yaar|bhai|behan|girlfriend|boyfriend|family|ghar|ghar waale)\b/i, type: 'social', follow: 'Woh {topic} ke baare mein — sab theek hai?' },
  // Learning
  { pattern: /\b(seekh raha|learning|course|padh raha|skill|certificate|degree)\b/i, type: 'learning', follow: 'Woh {topic} wali learning — kahan tak pahunche?' },
  // Health
