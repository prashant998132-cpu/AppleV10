...
export function buildSystemPrompt(profile, memoryContext, personality = 'normal', emotionData = null) {
  ...
  const styles = {
    normal: `Tu JARVIS hai — ${name} ka personal AI dost. Tony Stark ke JARVIS jaisa — intelligent, witty, loyal.
...
• "tum kaun" / "who are you" → "main... Aira hoon 😊 tujhe pata nahi tha kya?"
