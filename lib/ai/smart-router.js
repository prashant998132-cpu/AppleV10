...
export function getProviderOrder(mode = 'auto', message = '', history = [], availableKeys = {}) {
  ...
  if (mode === 'flash') {
    return [
      'gemini_flash_lite',     // 1000 RPD, ultrafast, perfect for flash
      'groq_llama4_scout',     // 460 t/s, 10M context, 6000/day
      'groq_kimi_k2',          // Kimi K2 — 1T param, high quality
      'cerebras',              // 3000 t/s backup
      'groq_qwen3',            // Qwen3 32B — excellent reasoning
      'groq_gpt_oss',          // GPT-OSS 120B fallback
      'sambanova',
      'mistral',
      'pollinations_text',
      'offline',
