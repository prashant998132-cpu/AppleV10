...
export const PROVIDERS = {
  ...
  gemini_flash: {
    ...
    tier: 1,
    url: 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-04-17:streamGenerateContent',
  ...
  groq_llama4_maverick: {
    name: 'Groq Llama 4 Maverick (deprecated — kept as fallback)',
    tier: 1,
    url: 'https://api.groq.com/openai/v1/chat/completions',
...
export function getProviderOrder(mode = 'auto', message = '', history = [], availableKeys = {}) {
  ...
  if (mode === 'flash') {
    return [
      ...
      'gemini_flash',          // Gemini (rate cut 92% Dec 2025 — last resort)
      'cerebras',
      'groq_llama4_maverick',
      'sambanova',
      'mistral',
