...
Ek tip: Complex calculations ke liye phone ka built-in calculator use karo.`,
  ...
  code: [
    'Offline hoon, lekin common fixes:\n1. Semicolon check karo\n2. Undefined variable check karo\n3. Async/await missing toh nahi?\n4. Console.log lagao debug ke liye',
    'Bug fix tip: Problem ko ek line mein describe karo. Aksar solution khud dikh jaata hai.',
    'Git tip: `git stash` karo naya branch banao — phir try karo.',
  ],
  productivity: [
    'Pomodoro: 25 min kaam, 5 min break. Repeat 4 times, phir 20 min break.',
    'Ek kaam ek time par. Multitasking myth hai.',
    'Day start tip: Pehle ek chota kaam complete karo — momentum milta hai.',
  ],
  crypto: [
    'Market volatile hai — invest only what you can afford to lose.',
    'DYOR — Do Your Own Research. Kisi ke keh ne par invest mat karo.',
  ],
  gold: [
    'Gold rate offline nahi aa sakta — goldprice.org ya 1800-102-xxxx pe check karo.',
    'Market khulne par check karo: MCX ya Google pe "gold rate today" search karo.',
  ],
  cricket: [
    'Live score ke liye Cricbuzz ya ESPN Cricinfo app use karo — main offline hoon.',
    'Network aane par bolunga. Tab tak Cricbuzz open karo!',
  ],
  movie: [
    'Movie info ke liye IMDB.com ya JustWatch.com — wahan sab milega.',
    'Google pe "[movie name] imdb" search karo — direct rating aayega.',
  ],
  error: [
