...
// ─── LOCAL GUEST USER — no login needed when Supabase off ──────
...
export async function getUser() {
  // No Supabase configured → return local guest (no login needed, no crash)
  if (!SUPABASE_ENABLED) return LOCAL_USER;
  try {
