// lib/db/queries.js — localStorage version (no Supabase needed)
// All data stored in browser localStorage

const LOCAL_USER_ID = 'local-user-jarvis';
...
export async function getProfile(userId) {
  return lsGet('jarvis_profile', { name: 'Pranshu', personality: 'normal', city: 'Rewa', language: 'hinglish' });
}
