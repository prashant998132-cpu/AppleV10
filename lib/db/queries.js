...
export async function checkAndAwardBadges(userId) {
  ...
  const newBadges = [];
  const BADGE_MAP = [
    { id:'first_chat',   xp:5,      name:'First Chat 🎉',     emoji:'🎉', desc:'Pehli baar baat ki!' },
    { id:'curious',      xp:50,     name:'Curious Mind 🔍',   emoji:'🔍', desc:'50 XP earned!' },
    { id:'regular',      xp:200,    name:'Regular ⚡',         emoji:'⚡', desc:'200 XP — daily user!' },
    { id:'dedicated',    xp:500,    name:'Dedicated 🎯',       emoji:'🎯', desc:'500 XP — committed!' },
    { id:'level5',       xp:2500,   name:'Level 5 ⭐',         emoji:'⭐', desc:'Reached Level 5!' },
    { id:'level10',      xp:10000,  name:'Level 10 🔥',        emoji:'🔥', desc:'Reached Level 10!' },
    { id:'power_user',   xp:50000,  name:'Power User 💎',      emoji:'💎', desc:'True JARVIS power user!' },
    { id:'centurion',    xp:100000, name:'Centurion 🏆',       emoji:'🏆', desc:'100k XP — legend!' },
  ];
